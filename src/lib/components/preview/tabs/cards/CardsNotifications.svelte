...
<Card.Root>
	...
	<Card.Content class="grid gap-1">
		...
		>
			...
			<div class="space-y-1">
				<p class="text-sm leading-none font-medium">Everything</p>
		...
		>
			...
			<div class="space-y-1">
				<p class="text-sm leading-none font-medium">Available</p>
		...
		>
			...
			<div class="space-y-1">
				<p class="text-sm leading-none font-medium">Ignoring</p>
